...
std::string WordChecker::hashDelete()
{
	return std::string();
}
...
std::string WordChecker::hashReplace()
{
	return std::string();
}
...
std::string WordChecker::hashSpace()
{
	return std::string();
}
